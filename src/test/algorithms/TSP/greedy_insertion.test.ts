...
import { greedyInsertionTSP } from "../../../algorithms/TSP/greedy_insertion";
...
describe("nearestNeighbor2OptTSP TSP tests", () => {
  ...
  test("Dublin: optimal TSP for x locations", () => {
    ...
    const result = greedyInsertionTSP(dublinGraph, targets, astar);
  ...
  test("Paris: optimal TSP for x locations", () => {
    ...
    const result = greedyInsertionTSP(parisGraph, targets, astar);
