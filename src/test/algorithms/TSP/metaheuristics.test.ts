...
import { metaheuristics } from "../../../algorithms/TSP/metaheuristics";
...
describe("metaheuristics TSP tests", () => {
  ...
  test("Dublin: optimal TSP for x locations", () => {
    ...
    const result = metaheuristics(dublinGraph, targets, astar);
  ...
  test("Paris: optimal TSP for x locations", () => {
    ...
    const result = metaheuristics(parisGraph, targets, astar);
