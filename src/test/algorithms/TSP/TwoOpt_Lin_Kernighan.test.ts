...
import { twoOptTSP } from "../../../algorithms/TSP/TwoOpt_Lin_Kernighan";
...
describe("twoOpt TSP tests", () => {
  ...
  test("Dublin: optimal TSP for x locations", () => {
    ...
    const result = twoOptTSP(dublinGraph, targets, astar);
  ...
  test("Paris: optimal TSP for x locations", () => {
    ...
    const result = twoOptTSP(parisGraph, targets, astar);
